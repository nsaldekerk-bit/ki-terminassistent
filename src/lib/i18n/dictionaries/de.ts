...
export const de = {
  ...
  admin: {
    ...
    services: {
      ...
      colDuration: "Dauer",
      colPrice: "Preis",
      colEmergency: "Notdienst",
      yes: "Ja",
      no: "Nein",
      minutes: "Min",
      empty: "Noch keine Dienstleistungen.",
      newTitle: "Neue Dienstleistung",
      name: "Name",
      category: "Kategorie",
    ...
    hours: {
      ...
      intro:
        'Ein Zeitfenster pro Tag. Ohne Uhrzeiten oder mit "Geschlossen" markiert bleibt der Tag frei von Terminen.',
      to: "bis",
      closed: "Geschlossen",
    },
    absences: {
      title: "Urlaub & Schließzeiten",
      intro: "In diesen Zeiträumen vergibt der Assistent keine Termine — Kunden sehen die Tage gar nicht erst.",
      empty: "Noch keine Schließzeiten eingetragen.",
      closedFallback: "Geschlossen",
      past: "vorbei",
      from: "Von",
      until: "Bis",
      reason: "Grund (optional)",
      reasonPlaceholder: "Betriebsurlaub",
    },
    faq: {
      title: "Eigene Fragen",
      intro:
        "Ihre eigenen Antworten auf typische Kundenfragen. Öffnungszeiten, Adresse, Telefon und Leistungen beantwortet der Assistent bereits von selbst — hier ergänzen Sie alles Betriebsspezifische.",
      empty: "Noch keine eigenen Fragen hinterlegt.",
      keywordsLabel: "Stichworte:",
      question: "Frage",
      answer: "Antwort",
      keywords: "Stichworte (optional)",
      questionPlaceholder: "Machen Sie auch Notdienst?",
      answerPlaceholder: "Ja, wir sind rund um die Uhr für Notfälle erreichbar.",
      keywordsPlaceholder: "notdienst, notfall, wochenende",
      keywordsHint: "Zusätzliche Wörter, bei denen diese Antwort passen soll — durch Komma getrennt.",
      addQuestion: "Frage hinzufügen",
    },
    profile: {
      title: "Betrieb",
      intro:
        "Stammdaten Ihres Betriebs. Der Assistent nutzt sie, um Kundenfragen zu beantworten — je vollständiger, desto besser.",
      contactLegend: "Kontakt & Sitz",
      contactHint:
      ...
      email: "E-Mail",
      website: "Website",
      emergencyLegend: "Notdienst",
      emergencyHint:
        "Wenn hier eine Nummer steht, bietet der Assistent Kunden im Notfall einen eigenen Schnellweg an — und markiert die Anfrage als dringend.",
      emergencyPhone: "Notfall-Telefon",
      emergencyNote: "Notfall-Hinweis",
      schedulingLegend: "Terminplanung",
      buffer: "Fahrzeit-Puffer",
      bufferUnit: "Minuten zwischen zwei Terminen",
      bufferHint:
        "Wird nach jedem Termin freigehalten, damit Sie zur nächsten Baustelle fahren können. 0 = kein Puffer.",
      area: "Einzugsgebiet",
      areaHint:
        "Postleitzahlen, in die Sie fahren — durch Komma getrennt. Leer lassen heißt: keine Prüfung, Sie fahren überall hin.",
    },
    status: "Status",
    details: "Details",
    requests: {
      ...
      statusCancelled: "Vom Kunden abgesagt",
    },
    requestDetail: {
      titlePrefix: "Anfrage",
      allRequests: "← Alle Anfragen",
      emergency: "🚨 NOTFALL",
      typeConsultation: "Beratung / Rückruf",
      typeBooking: "Termin buchen",
      rowType: "Art",
      rowService: "Leistung",
      rowArea: "Fläche",
      rowLocation: "Ort",
      rowPreferred: "Wunschtermin",
      rowReachable: "Erreichbar",
      rowCustomer: "Kunde",
      rowContact: "Kontakt",
      rowReference: "Vorgangsnummer",
      rowReceived: "Eingegangen",
      rowConsent: "Datenschutz",
      consentGiven: (d: string) => `Einwilligung erteilt am ${d}`,
      rowReminder: "Erinnerung",
      reminderSent: (d: string) => `Verschickt am ${d}`,
      rowRescheduled: "Verschoben am",
      rowCancelled: "Abgesagt am",
      manageTitle: "Terminlink des Kunden",
      manageHint:
        "Damit verschiebt oder storniert der Kunde selbst. Nur weitergeben, wenn er die Bestätigung verloren hat.",
      situation: "Situation",
      photosTitle: (n: number) => `Fotos (${n})`,
      photoAlt: "Kundenfoto",
      replyTitle: "Antwort an den Kunden",
    },
    appointments: {
      title: "Termine",
      time: "Zeitpunkt",
    ...
    conversations: {
      ...
      detailTitle: (name: string) => `Gespräch mit ${name}`,
    },
    embed: {
      title: "Einbetten",
      introBefore: "Füge diesen Code kurz vor dem schließenden ",
      introAfter: "-Tag deiner Webseite ein, um den Chat-Assistenten einzubinden.",
    },
    reply: {
      noEmail: "Für diesen Kunden ist keine E-Mail-Adresse hinterlegt — eine Antwort per E-Mail ist nicht möglich.",
      placeholder: "Ihre Nachricht an den Kunden …",
      send: "Antwort an Kunden senden",
      sending: "Wird gesendet …",
      openMail: "Stattdessen im E-Mail-Programm öffnen",
      sentTo: (email: string) => `Antwort an ${email} gesendet. Status wurde auf „Kontaktiert" gesetzt.`,
      hint: 'Gesendet wird über den hinterlegten E-Mail-Versand. Ist noch keiner eingerichtet, nutzen Sie "Im E-Mail-Programm öffnen" — das öffnet Ihr gewohntes Mailfach mit vorausgefüllter Adresse.',
    },
    login: {
      title: "Anmelden",
      email: "E-Mail",
